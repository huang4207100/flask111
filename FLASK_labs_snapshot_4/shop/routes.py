...
def add_items():
    items = [
        {'title': '猫咪项圈1', 'description': '这是一个比较便宜的产品,欢迎你购买', 'price': 20, 'image_file': '1.jpg'},
        {'title': '猫咪项圈2', 'description': '这是一个比较便宜的产品,欢迎你购买', 'price': 100, 'image_file': '2.jpg'},
        {'title': '猫咪零食1', 'description': '这是一个比较便宜的产品,欢迎你购买', 'price': 200, 'image_file': '3.jpg'},
        {'title': '猫咪零食2', 'description': '这是一个比较便宜的产品,欢迎你购买', 'price': 1000, 'image_file': '4.jpg'},
        {'title': '猫咪零食3', 'description': '这是一个比较便宜的产品,欢迎你购买', 'price': 5000, 'image_file': '5.jpg'}
    ]
    for item in items:
        book = Book(title=item['title'], description=item['description'], price=item['price'], image_file=item['image_file'], stock_level=5)
        db.session.add(book)
        db.session.commit()
